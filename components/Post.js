...
import {BookmarkIcon,
ChatIcon,DotsHorizontalIcon,EmojiHappyIcon,HeartIcon,
PaperAirplaneIcon,} from "@heroicons/react/outline";
import {HeartIcon as HeartIconFilled} from "@heroicons/react/solid";
import {useSession} from "next-auth/react";
import {useState} from "react";
import { addDoc,collection,query, serverTimestamp,onSnapshot, orderBy,setDoc,doc, deleteDoc, } from 'firebase/firestore';
...
{/*<BookmarkIcon className="btn"/>*/}
        ...
        {comments.length> 0 && (
<div className="ml-10 h-20 pverflow-y-scroll
